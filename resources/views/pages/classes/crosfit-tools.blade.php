        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-xs-12 content-area order-lg-2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="margin_bottom25">
                                <img class="img-fluid"
                                    src="{{ asset('statics/images/portfolio/portfolio-005-1200x800.jpg') }}" alt="image">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="margin_bottom25">
                                <img class="img-fluid"
                                    src="{{ asset('statics/images/portfolio/portfolio-009-1200x800.jpg') }}" alt="image">
                            </div>
                            <h3 class="fs-30 margin_top30">A Reason of Your Health, Join Today</h3>
                            <p>If you don’t do anything to replace the muscle loss, it’ll be replaced with fat. But weight
                                training can help you.</p>
                            <ul class="ttm-list ttm-list-style-icon font-weight-normal ttm-list-icon-color-highlight mb-10">
                                <li>
                    ...
                    <div class="ttm-bgcolor-grey slick_slider margin_top70"
