import { f as boot } from "./index.94c1c68b.js";
import { c as core, A as Api } from "./api.636d00fa.js";
...
function lighten(color, percent) {
  ...
  return (
    ...
    (
      16777216 +
      (Math.round((t - R) * p) + R) * 65536 +
      (Math.round((t - G) * p) + G) * 256 +
      (Math.round((t - B) * p) + B)
    )
      .toString(16)
      .slice(1)
      ...
      utils$c.forEach(data2, function each(value, key) {
        ...
        if (value && !parentKey && typeof value === "object") {
          if (utils$c.endsWith(key, "{}")) {
            ...
            utils$c.endsWith(key, "[]") &&
            (arr = utils$c.toArray(value))
          ) {
            arr.forEach(function (el) {
              !utils$c.isUndefined(el) &&
...
var utils$b = utils$h;
var cookies$1 = utils$b.isStandardBrowserEnv()
...
var utils$9 = utils$h;
var isURLSameOrigin$1 = utils$9.isStandardBrowserEnv()
  ? (function standardBrowserEnv2() {
      ...
      return function isURLSameOrigin2(requestURL) {
        var parsed = utils$9.isString(requestURL)
  ...
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (config.cancelToken || config.signal) {
      onCanceled = function (cancel) {
        ...
        reject(
          !cancel || (cancel && cancel.type) ? new CanceledError$2() : cancel
        );
        request2.abort();
        request2 = null;
      };
...
var defaults$3 = {
  ...
  transformRequest: [
    function transformRequest(data2, headers) {
      ...
      var isFileList2;
      if (
        (isFileList2 = utils$6.isFileList(data2)) ||
