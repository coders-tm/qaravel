        ...
        <div v-if="editable" class="col-sm-3">
          <q-card flat bordered class="full-height">
            <q-card-section>
              ...
              <div class="q-mt-sm">
                Alt text (alternative text) to media is first and foremost a
                principle of web accessibility. Visually impaired users using
                screen readers will be read an alt attribute to better
...
export default {
  ...
  methods: {
    ...
    onReset() {
      ...
      this.$core
        .confirm(
          "This action can't be undone. You have unsaved edits that you will lose.",
          {
