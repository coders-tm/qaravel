    ...
    <q-card>
      <q-card-section>
        <base-table
          ...
          no-data-label="No templates avaialble"
          no-permissions
        >
...
export default {
  ...
  methods: {
    ...mapActions(useTemplateStore, ["get", "changeActive"]),
    onRequest(props) {
      console.func(
        "admins/templates/TemplatesPage:methods.onRequest()",
        arguments
      );
    ...
    async actionClicked(action, row) {
      console.func(
        "admins/templates/TemplatesPage:methods.actionClicked()",
        arguments
      );
    },
    async toolbarClicked(action, row) {
      console.func(
        "admins/templates/TemplatesPage:methods.toolbarClicked()",
        arguments
      );
    },
    async rowClicked(evt, row) {
      console.func(
        "admins/templates/TemplatesPage:methods.rowClicked()",
        arguments
      );
      this.$router.push({
        name: "Single Template",
